        ...
        <SwiperSlide>
          <div className="__s_container bg-[url('/images/school/education-bg.svg')] bg-no-repeat bg-cover px-4">
            <div className="parent">
              ...
              <div className="div3">
                {/* 3 */}
                <img src="images/health/food-1.jpg" alt="" />
              </div>
              <div className="div4">
                {/* 4 */}
                <img src="images/health/asset-4.jpg" alt="" />
              </div>
              <div className="div5">
                {/* 5 */}
                <img src="images/health/food-3.jpg" alt="" />
              </div>
              <div className="div6 relative">
                {/* 6 */}

                <span className="absolute top-4 left-4 z-50 h-full w-full bg-gradient-to-t from-black transform -translate-4 flex flex-col items-baseline justify-end text-white p-4">
                  <h1 className="">djsfhskf</h1>
                  <p className="text-justify">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Non
                    numquam placeat sed ut.
                  </p>
                </span>
                <img
                  src="images/health/food-supply.jpg"
                  alt=""
              ...
              <section className="flex h-full text-white">
                <div className="flex justify-between items- h-full">
                  <div className="max-w-xl text-">
                    ...
                    <h1 className="ml-6 mt-8 text-4xl font-semibold leading-tight">
                ...
                <div className="flex justify-between items- h-full bg-secondary">
                  <div className="max-w-xl text-">
                    {/* <span className="italic text-2xl border-l-24 border-accent ">
                      #Did you know
                    </span> */}
                    <h1 className="mx-6 mt-8 text-4xl font-semibold leading-tight">
                      There is
                  ...
                  <img
                    src="\images\health\food-hero-2.jpg"
                    alt=""
                    loading="lazy"
                    className="h-full w-[50%] object-cover"
                  />
